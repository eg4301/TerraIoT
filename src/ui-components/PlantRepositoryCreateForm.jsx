...
import { createPlantRepository } from "../graphql/mutations";
const client = generateClient();
export default function PlantRepositoryCreateForm(props) {
  const {
    clearOnSuccess = true,
    onSuccess,
    onError,
  ...
  const resetStateValues = () => {
    setCrops(initialValues.Crops);
    setName(initialValues.Name);
    setNitrogen_upper(initialValues.nitrogen_upper);
    setNitrogen_lower(initialValues.nitrogen_lower);
    setEc_upper(initialValues.ec_upper);
    setEc_lower(initialValues.ec_lower);
    setPH_upper(initialValues.pH_upper);
    setPH_lower(initialValues.pH_lower);
    setErrors({});
  };
  const validations = {
    Crops: [{ type: "Required" }],
  ...
  return (
    <Grid
      ...
      onSubmit={async (event) => {
        ...
        try {
          ...
          await client.graphql({
            query: createPlantRepository.replaceAll("__typename", ""),
            variables: {
              input: {
                ...modelFields,
              },
      ...
      {...getOverrideProps(overrides, "PlantRepositoryCreateForm")}
      {...rest}
    >
      <TextField
        label="Crops"
