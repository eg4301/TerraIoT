...
// Import CO2 Data
import { CO2_data } from "../api_query";

export function GetCO2Data() {
    // const [data, setData] = useState({'widget':[{'data':{'co2':[[1705588926000, 5.0000]]},'display':'absolute'},{},{},{},{}]})
    // const data = {'widget':[{'data':{'co2':[[1705588926000, 5.0000]]},'display':'absolute'},{},{},{},{}]}
    if (CO2_data.widget != undefined) {
    const data = CO2_data
    const points = data.widget[0].data.CO2
    ...
    return (
        class CO2_Chart extends React.Component {
            constructor(props) {
                super(props);
                this.state = {
                    ...
                    <Resizable>
                        ...
                        >
                            <ChartRow height = "180">
                                ...
                                />
                                <Charts>
                                    <ScatterChart axis="CO2" series={croppedSeries} style={style} />
                                    <LineChart axis='CO2' series = {croppedSeries} style={style} />
                                    <Baseline
                                        axis="CO2"
...
const CO2_Chart = new GetCO2Data()
